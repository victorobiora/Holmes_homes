import { demoOrders } from "../orders.dto";
...
const paginatedListings = paginate(demoOrders.ongoing);

console.log(paginatedListings);

const OngoingOrdersTable = () => {
	...
	const [ordersShowing, setOrdersShowing] = useState<{
		index: number;
		data: {
			title: string;
			address: string;
			...
			<section className="TabletScreen:hidden MobileScreen:hidden">
				<div className="p-4  rounded-md">
					...
					<table className="w-full border-collapse">
						...
						<tbody>
							{ordersShowing.data.map((listing, index) => (
								<tr
									key={index}
	...
	const mobileView = () => {
		return (
			<section className="DesktopScreen:hidden TabletScreen:hidden">
				<div className="p-4 rounded-md mt-4 relative">
					<div className="px-2 py-4 bg-white flex justify-between items-center">
						<h2 className="text-xl font-semibold ">Your Orders</h2>
						<div className="flex gap-[2rem] items-center">
							<motion.button
