...
export const customerItemStructure = {
	name: "Chike Chidi",
	id: 12345,
	status: "active",
	...
	customerLicense: "LC-5758-2048-3944",
	...
	reviews: [
		{
			...
			rating: 5,
			comment:
				"The team at user went above and beyond to understand my needs and tailor their solutions to fit my business requirements Not only did they exceed our expectations.",
			date: "3 days ago",
		},
		{
			reviewer: "Bob",
