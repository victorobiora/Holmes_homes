import { demoAgentManagementDetails } from "@/app/admin/admin.dto";
...
const paginatedProperties = paginate(demoAgentManagementDetails);

console.log(paginatedProperties);

const UserManagementAgentTable = () => {
						...
						<tbody className="bg-white">
							{propertiesShowing.data.map((item, index) => (
								...
								>
									...
									<td className="p-4 min-w-[15rem]">{item.experience}</td>
...
export default UserManagementAgentTable;
