		...
		return (
			...
			>
				...
				<div className="flex">
					...
					>
						<span className="mx-1"> + </span> Add Member
					</motion.button>
					...
					<motion.button
						...
						whileTap={{ scale: 0.9 }}
						className={`px-2 py-2 mx-4 ml-2 rounded-md text-[#435769] bg-holmes-background-light-grey shadow-md w-32`}
						onClick={(event) => {
							event.preventDefault();
							router.push("/");
						}}
